...
class Game:
    def __init__(self):
        ...
        self.font = pygame.font.Font(resource_path('assets/font/Oxanium-Bold.ttf'), 40)
        self.explosion_frames = [pygame.image.load(resource_path(f'assets/explosion/{i}.png')).convert_alpha() for i in range(21)]

        # sounds
        self.laser_sound = pygame.mixer.Sound(resource_path('assets/audio/laser.ogg'))
        self.laser_sound.set_volume(0.5)
        self.explosion_sound = pygame.mixer.Sound(resource_path('assets/audio/explosion.ogg'))
        self.game_music = pygame.mixer.Sound(resource_path('assets/music/game_music.ogg'))
